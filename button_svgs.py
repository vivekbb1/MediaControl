...
ICON_SVGS: dict[str, str] = {
    ...
    "num_0": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">0</text></svg>'),
    "num_1": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">1</text></svg>'),
    "num_2": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">2</text></svg>'),
    "num_3": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">3</text></svg>'),
    "num_4": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">4</text></svg>'),
    "num_5": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">5</text></svg>'),
    "num_6": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">6</text></svg>'),
    "num_7": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">7</text></svg>'),
    "num_8": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">8</text></svg>'),
    "num_9": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="12" y="17" font-size="14" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">9</text></svg>'),
    "ch_up": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 15 12 9 18 15"/><text x="12" y="21" font-size="7" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">CH</text></svg>'),
    "ch_down": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9 12 15 18 9"/><text x="12" y="23" font-size="7" font-weight="bold" text-anchor="middle" fill="currentColor" stroke="none">CH</text></svg>'),
    "last": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 6 9 18"/><path d="M3 6l12 12"/><path d="M21 18 9 6"/><path d="M3 18 15 6"/></svg>'),
    "guide": _svg('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="5" width="18" height="14" rx="1.5"/><path d="M3 9h18"/><rect x="6" y="12" width="4" height="3" rx="0.5"/><rect x="6" y="16" width="4" height="2" rx="0.5"/><rect x="11" y="12" width="4" height="3" rx="0.5"/><rect x="11" y="16" width="4" height="2" rx="0.5"/></svg>'),
    "record": _svg('<svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="7"/></svg>'),
    "play": _svg('<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>'),
    "pause": _svg('<svg viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>'),
    "stop": _svg('<svg viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="6" width="12" height="12" rx="1"/></svg>'),
    "rewind": _svg('<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11 19V5l-9 7zM22 19V5l-9 7z"/></svg>'),
    "forward": _svg('<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 5v14l9-7zM4 5v14l9-7z"/></svg>'),
}
